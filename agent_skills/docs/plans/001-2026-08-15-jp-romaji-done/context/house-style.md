...
Plan-time attachment. Living copy after stage 02: `jp-romaji/house-style.md` only. Do not implement in `scripts/romaji`. Do not copy this file into the prompts; attach it.

Audience: speak or sing the line.
