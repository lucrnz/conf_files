# prompts/media.md (normative draft)

Plan-time attachment. Living copy after stage 02: `jp-romaji/prompts/media.md`. This file is the **only** home for the authority list and blast radius. Stage 02 copies this body (without this header note).
